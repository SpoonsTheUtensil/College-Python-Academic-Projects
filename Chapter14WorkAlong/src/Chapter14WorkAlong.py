...
Create a GUI application that will create, save and open a text file.
'''
...
class Editor(Frame):
    ...
    def __init__(self):
        ...
        #Command buttons
        self._newBtn = Button(self, text = "New", command = self._newFile)
        self._newBtn.grid(row = 1, column = 0)
        
        self._openBtn = Button(self, text = "Open", command = self._openFile)
        self._openBtn.grid(row = 1, column = 1)
        
        self._saveBtn = Button(self, text = "Save", command = self._saveFile)
    ...
    def _openFile(self):
        ...
        if os.path.exists(self._filename):
            ...
            tkinter.messagebox.showerror(message = "File does not exist!", parent = self)
    ...
    def _saveFile(self):
        ...
        if self._filename != '':
            ...
            tkinter.messagebox.showerror(message = "Must enter a file name!", parent = self)
